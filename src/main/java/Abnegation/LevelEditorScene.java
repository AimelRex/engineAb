...
public class LevelEditorScene extends Scene{
    ...
    @Override
    public void init(){
        //we will compile and link the shaders

        //First, we will load and compile the vertex shader
        vertexID = glCreateShader(GL_VERTEX_SHADER);

        //then we will pass the shader source code to the gpu
        glShaderSource(vertexID, vertexShaderSrc);
        glCompileShader(vertexID);

        //Check for errors, get shader info
